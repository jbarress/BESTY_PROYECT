    ...
    switch (action) {
        case "open":
          try{
            ...
            var link = extraerURL(await chatbot("Escribe el url de "+ object+" porfavor no escribas nada mas, tu respuesta la usare de manera que si escribes algo mas que la url mi codigo no funcionara"))
            conf.url = link;
