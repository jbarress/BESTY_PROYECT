  ...
  switch (action) {
    ...
    case 'edit':
      ...
      const datosActualizados = {
        nombre: 'Nombre actualizado', // reemplaza estos valores con los datos actualizados que deseas enviar
        telefono: 'Teléfono actualizado',
        email: 'Email actualizado'
      };
      
      await axios.put(`http://localhost:8080/contactos/${contactoId}`, datosActualizados)
        .then(response => {
          console.log(response.data);
