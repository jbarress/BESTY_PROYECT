...
async function transformDate(number, dayStr) {
    ...
    var dataChat = await chatbot("Transforma a formato (año-mes-dia hora:minutos:segundos) el siguiente input: '" + dayStr + 'a las ' + number + "'" + ". Deseo que tu respuesta tan solo sea la transformacion del input a su respectivo formato y en horario español, no digas nada mas porfavor, recuerda que estamos en abril del 2023")
