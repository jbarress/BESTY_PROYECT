// window.addEventListener('load', ()=>{
  ...
  .then(data => {
      ...
      if(data.idMusic !== ''){
        ...
        var link = "https://open.spotify.com/embed/track/"+4xTd8fz0mZFK5b9IYdGKNd+"?utm_source=generator&theme=0";
        console.log(data.idMusic);
        musica.setAttribute('src', data.idMusic);
      }else{
