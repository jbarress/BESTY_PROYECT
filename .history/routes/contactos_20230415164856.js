...
app.post('/', async (req, res) => {
    ...
    try {
        ...
        res.render('index', {respuestaBot: 'Contacto guardado con exito'})
    } catch (error) {
        console.log(error);
        res.render('index', {respuestaBot: 'No he podido guarda el contacto'}); // Devuelve un error si no se pudo guardar el evento
    }
});
